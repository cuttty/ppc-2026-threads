...
bool FrolovaSRadixSortDoubleOMP::RunImpl() {
  ...
  for (int pass = 0; pass < num_passes; ++pass) {
    ...
    // 1. Параллельный подсчёт гистограммы
...
#pragma omp critical
    ...
    // 3. Параллельное распределение элементов во временный массив с проходом исходного массива в обратном порядке
...
#pragma omp atomic capture
  ...
  // 4. Коррекция порядка отрицательных чисел
